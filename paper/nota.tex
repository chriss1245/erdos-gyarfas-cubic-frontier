...
\author{Christopher Andre Manzano Vimos\\
  ...
  \small \texttt{eci@whiteboxml.com} \quad
...
(private during review; to be made public alongside a Zenodo deposit, whose DOI
will be minted on publication). The repository contains the
